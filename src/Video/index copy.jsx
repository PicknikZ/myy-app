    ...
    switch (this.state.step) {
      case 1:
        ...
        <div>1. Convert Video Pixel Format</div>
          <div style={{display: 'flex', marginTop: '50px'}}>
            <Select placeholder='Please Select Video Pixel Format' defaultValue={"420"} size="large" style={{width: '300px'}} onChange={(v)=>this.onChange(v, 1)}>
      ...
      case 2:
        ...
        <div>2. Convert Video Format</div>
          <div style={{display: 'flex', marginTop: '50px'}}>
            <Select placeholder='Please Select Video Format' defaultValue={"mp4"} size="large" style={{width: '300px'}} onChange={(v)=>this.onChange(v, 2)}>
      ...
      case 3:
        ...
        <div>3. Convert video bitrate</div>
          <div style={{display: 'flex', marginTop: '50px'}}>
            <Select placeholder='Please Select Video Bitrate' defaultValue={"500k"} size="large" style={{width: '300px'}} onChange={(v)=>this.onChange(v, 3)}>
      ...
      case 4: 
        ...
        <div>4. Convert video frame rate</div>
          <div style={{display: 'flex', marginTop: '50px'}}>
            <Select placeholder='Please Select Frame Rate' defaultValue={"30"} size="large" style={{width: '300px'}} onChange={(v)=>this.onChange(v, 4)}>
      ...
      case 5:
        return <div style={{display: 'block'}}>
          <div>5. Convert video format</div>
            <div style={{display: 'flex', marginTop: '50px'}}>
              <Select placeholder='Please Select Video Resolution' defaultValue={"640x360"} size="large" style={{width: '300px'}} onChange={(v)=>this.onChange(v, 5)}>
      ...
      case 6:
        ...
        <div>6. Convert video encoding format</div>
          <div style={{display: 'flex', marginTop: '50px'}}>
            <Select placeholder='Please Select Video Encoding Format' size="large" style={{width: '300px'}} onChange={(v)=>this.onChange(v, 6)}>
